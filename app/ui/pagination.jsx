  ...
  return (
    <div className="mb-4">
      <div className="flex md:text-xl text-base justify-center gap-2">
        <button
          className="border border-black px-2 py-1 min-w-8 bg-[#F2B705] rounded-md hover:bg-[#f2b705c9]"
          onClick={decPage}
        >
          &larr;
        </button>
        <p className="border border-black px-2 py-1 min-w-8 text-center bg-slate-300">
          1
        </p>
        <input
          type="text"
        ...
        <button
          className="border border-black px-2 py-1 min-w-8 bg-[#F2B705] rounded-md hover:bg-[#f2b705c9] text-center"
          onClick={incPage}
        >
          &rarr;
        </button>
      ...
      <div className="absolute top-0 right-2 flex gap-2">
        <label htmlFor="pageSize" className="font-bold">
          Orders/page
        </label>
        <select
          name="pageSize"
